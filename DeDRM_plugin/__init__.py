...
class DeDRM(FileTypePlugin):
    ...
    def KindleMobiDecrypt(self,path_to_ebook):
        ...
        try:
            ...
            try:
                ...
                print(u"{0} v{1}: Exception when getting default Kindle Key after {2:.1f} seconds".format(PLUGIN_NAME,
                                                                                                          PLUGIN_VERSION,
            ...
            if not decoded:
                ...
                print(u"{0} v{1}: Ultimately failed to decrypt after {2:.1f} seconds. Read the FAQs at Harper's repository: https://github.com/apprenticeharper/DeDRM_tools/blob/master/FAQs.md".format(
    ...
    def eReaderDecrypt(self,path_to_ebook):
        ...
        for keyname, userkey in dedrmprefs['ereaderkeys'].items():
            ...
            if  result == 0:
                print(u"{0} v{1}: Successfully decrypted with key {2:s} after {3:.1f} seconds".format(PLUGIN_NAME,
                                                                                                       PLUGIN_VERSION,
                                                                                                       keyname_masked,
                                                                                                       time.time() - self.starttime))
                return of.name
